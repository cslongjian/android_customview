...
//                 System.out.println("属性"+r.getCell(9).getStringCellValue());


//                 读取0 ，2 ，9 第0个有，第2个有，第9个没的条件下才打印出来。
...
//                if ((r.getCell(0).getNumericCellValue() != 0.0) && (r.getCell(9).getStringCellValue().equals(""))) {
////
...
//                 //------正确读取 导出MAP    注意数对。列数的位置。。从0列开始的
                 ...
                 if (r.getCell(12).getStringCellValue()!=null&&!r.getCell(12).getStringCellValue().equals(""))
                 {
                     stringBuilder.append(",\""+r.getCell(12).getStringCellValue()+"\"");
                 }

                if (r.getCell(14).getStringCellValue()!=null&&!r.getCell(14).getStringCellValue().equals(""))
                {
                    stringBuilder.append(",\""+r.getCell(14).getStringCellValue()+"\"");
                }
